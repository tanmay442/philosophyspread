...
imageAlt: "Abstract stry night style representation of how it feels doin metaphysical analysis"
pubDate: "2026-06-02"
featured: false
---
...
<br/>
Traditionally metaphysics from the work of Aristotle can be broken down into these two distinct subjects of researches:
<br/>
...
<br/>
But some of you now may say, that we are committing a logical fallacy, maybe you are just a person of wits or just have read through the <a href="/logic-modules/module04-logicalfallacies">Logic Module 4: A Guide to Logical Fallacies</a>, you may identify the **The Fallacy of Composition** in here —Aristotle argues that because individual objects within the universe require a cause, the entire universe as a whole must require a cause, this is not necessarily true the system as a whole may have different nature than the components it is made up of.
<br/>
But still there is a decent case for it, theologians have an edge here, as the burden of proof lies on the non-theistic people here.
<br/>
## The Study of Being
