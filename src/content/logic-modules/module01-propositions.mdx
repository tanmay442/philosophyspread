...
<div class="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6 items-stretch">
  ...
  <div class="bg-surface-container-low border border-stone-900 p-6 flex flex-col justify-between">
    <div>
      <h4 class="font-bold text-emerald-800 mb-4 text-lg m-0">Premise Indicators</h4>
      <ul class="grid grid-cols-[auto_1fr] gap-x-8 gap-y-2 font-body list-none p-0 m-0 text-stone-800">
  ...
  <div class="bg-surface-container-low border border-stone-900 p-6 flex flex-col justify-between">
    <div>
      <h4 class="font-bold text-stone-900 mb-4 text-lg m-0">Conclusion Indicators</h4>
      <ul class="grid grid-cols-[auto_1fr] gap-x-8 gap-y-2 font-body list-none p-0 m-0 text-stone-800">
