...
<Callout type="info" title="The Fundamental Test:">
...
<InteractiveQuiz id="module01-propositions" questions={propQuiz} />
...
<Callout type="example" title="Example: Shifting Roles">
**Argument A:**
...
<div class="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6 items-stretch">

  <div class="bg-surface-container-low border border-secondary p-6 flex flex-col justify-between">
    <div>
      <h4 class="font-bold text-primary mb-4 text-lg m-0">Premise Indicators</h4>
      <ul class="grid grid-cols-[auto_1fr] gap-x-8 gap-y-2 font-body list-none p-0 m-0 text-on-surface">
        <li class="whitespace-nowrap">since</li>
        <li class="whitespace-nowrap">seeing that</li>

        <li class="whitespace-nowrap">because</li>
        <li class="whitespace-nowrap">for the reason that</li>

        <li class="whitespace-nowrap">for</li>
        <li class="whitespace-nowrap">inasmuch as</li>

        <li class="whitespace-nowrap">as</li>
        <li class="whitespace-nowrap">owing to</li>

        <li class="whitespace-nowrap">given that</li>
        <li class="whitespace-nowrap">if...</li>
      </ul>
    </div>
  </div>
  ...
  <div class="bg-surface-container-low border border-secondary p-6 flex flex-col justify-between">
    <div>
      <h4 class="font-bold text-on-surface mb-4 text-lg m-0">Conclusion Indicators</h4>
      <ul class="grid grid-cols-[auto_1fr] gap-x-8 gap-y-2 font-body list-none p-0 m-0 text-on-surface">
        <li class="whitespace-nowrap">therefore</li>
        <li class="whitespace-nowrap">it follows that</li>

        <li class="whitespace-nowrap">thus</li>
        <li class="whitespace-nowrap">we may conclude</li>

        <li class="whitespace-nowrap">hence</li>
        <li class="whitespace-nowrap">as a result</li>

        <li class="whitespace-nowrap">so</li>
        <li class="whitespace-nowrap">which means that</li>

        <li class="whitespace-nowrap">consequently</li>
        <li class="whitespace-nowrap">...then</li>
      </ul>
    </div>
  </div>
</div>
...
<Callout type="example" title="Example: Celebrity Endorsement">
...
<Callout type="example" title="Example: Chain of Consequences">
...
<Callout type="example" title="Socrates' Dilemma">
...
<InteractiveQuiz id="module01-practice" questions={pracQuiz} />
