...
- **Astro (SSR on Cloudflare)** — Server-rendered with the Cloudflare adapter
...
- **Custom sitemap route** — Generated by [src/pages/sitemap.xml.ts](src/pages/sitemap.xml.ts)
...
Hosted on **Cloudflare Workers** for low-latency global delivery with dynamic SSR support.
